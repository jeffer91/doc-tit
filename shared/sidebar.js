(() => {
  ...
  function loadPendingSummary(){
    ...
    loadScriptOnce("data-doc-tit-pending-summary","shared/pending-summary.js?v=20260915-2");
  }
  ...
  function init(){
    ...
    loadSectionManifest();loadSvdShell();loadReferenceUI();loadMultiSchedules();loadPendingSummary();
  }
