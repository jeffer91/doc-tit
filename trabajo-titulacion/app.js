...
function currentAuthorizationsSnapshot(){
...
function normalizePayloadData(data){
  ...
  if(!contentSnapshots.methodology||contentSnapshots.methodology?.technicalVersion==="A")contentSnapshots.methodology=currentMethodologySnapshot();
...
function renderTable(key){
  ...
  const body=$("#tbody-"+key);if(!body)return;
